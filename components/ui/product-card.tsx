...
const ProductCard: React.FC<ProductCardProps> = ({ data }) => {
  ...
  return (
    <div
      onClick={handleClick}
      className={`relative bg-white border group rounded-xl overflow-hidden cursor-pointer ${anek.className}`}
    >
      ...
      {/* Description */}
      <div>
        <p className="font-semibold text-wrap w-[300px] text-lg px-4 mt-2">{data.name}</p>
      </div>
